...
Eles validam documentação, task graph, 42 schemas e exemplos, OpenAPI/AsyncAPI, invariantes do banco, configuração nativa do Codex, inventário da V1 e padrões comuns de segredo.
