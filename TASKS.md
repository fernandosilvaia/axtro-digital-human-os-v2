...
- [ ] **T11 · Meet/Zoom/Teams (Recall.ai)** — mesma decisão e mesmo racional do T10 (M3b, sem sandbox, sem requisito ativo).
...
- [~] **T13 · Migrar leituras do portal para RLS-por-claim** — dívida D-V2-058; o Auth Hook está ativo desde D-V2-063 (bloqueador original resolvido) — desbloqueado, entrando em execução.
