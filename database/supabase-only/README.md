...
- O runtime recuperado reconhece como compatíveis somente v50 e v56 quando `PORTAL_BUSINESS_ACTION_BRIDGE_ENABLED=false`: ambas precisam publicar todas as capabilities base e `meetingTerminalNotificationClaim=true`. As versões v48-v49 não oferecem essa claim; v51-v55 apagam a chave ao republicar o documento de capabilities e, portanto, exigem a 0056 antes deste runtime. Com a bridge de ações de negócio habilitada, somente v56 com todas as capabilities de ação de negócio é aceita.
